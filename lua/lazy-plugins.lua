...
require('lazy').setup({
  ...
  -- NOTE: The import below can automatically add your own plugins, configuration, from `lua/plugins/*.lua`
  ...
  require '/plugins/vim-fern', --file explorer

  require '/plugins/neo-tree', --file explorer

  require '/plugins/indent-blankline', --indent collor
